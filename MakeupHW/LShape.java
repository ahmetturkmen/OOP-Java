...
public class LShape extends Shape {
	...
	public LShape(int x, int y, int w, int h) {
		super(x, y, w, h);
	...
	public void draw(Graphics graphics) {
		...
		graphics.setColor(randomColor);
		graphics.fillRect(super.getX() + 50, super.getY() + 100, super.getW(), super.getH());
		graphics.setColor(Color.black);
		graphics.drawRect(super.getX() + 50, super.getY() + 100, super.getW(), super.getH());
