...
public class TShape extends Shape {
	...
	public void draw(Graphics graphics) {
		...
		graphics.setColor(randomColor);
		graphics.fillRect(super.getX() + 50, super.getY(), super.getW(), super.getH());
		graphics.setColor(Color.black);
		graphics.drawRect(super.getX() + 50, super.getY(), super.getW(), super.getH());

		graphics.setColor(randomColor);
		graphics.fillRect(super.getX() + 100, super.getY(), super.getW(), super.getH());
		graphics.setColor(Color.black);
		graphics.drawRect(super.getX() + 100, super.getY(), super.getW(), super.getH());

		graphics.setColor(randomColor);
		graphics.fillRect(super.getX() + 50, super.getY() + 50, super.getW(), super.getH());
		graphics.setColor(Color.black);
		graphics.drawRect(super.getX() + 50, super.getY() + 50, super.getW(), super.getH());
